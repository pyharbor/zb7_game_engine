...
def asdf():
    ...
    r = Relics.JadeNecklace()
    r2 = Recruits.Arachnida.AsianForestScorpion(health=500, max_health=500)
    ...
    r = Recruits.Arachnida.AsianForestScorpion(health=100, max_health=100)
