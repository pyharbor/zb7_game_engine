...
def asdf():
    ...
    r = Recruits.Arachnida.JumpingSpider(melee_attack=1)
    r2 = Recruits.Arachnida.JumpingSpider(ranged_attack=20)
    enemy_shop_snapshot.current_state.add_recruit(recruit=r, index=0)
    enemy_shop_snapshot.current_state.add_recruit(recruit=r2, index=1)
