...
def asdf():
    ...
    r = Relics.TropicalThunderstorm()
    r2 = Recruits.Arachnida.AsianForestScorpion(armor=50)
    ...
    r = Recruits.Arachnida.AsianForestScorpion(armor=50)
    enemy_shop_snapshot.current_state.add_recruit(recruit=r, index=1)

    # Battle
    battle_snapshot = GameEngine.reconcile_battle(friendly_shop_snapshot=friendly_shop_snapshot,
                                                  enemy_shop_snapshot=enemy_shop_snapshot)
