...
def asdf():
    ...
    r = Relics.TreasureChest(shop_id=10)
    friendly_shop_snapshot.current_state.shop[0] = r
    ...
    GameEngine.reconcile_shop_user_input(
        ...
        user_input=ShopUserInput(op=GameConstants.Opcodes.Shop.shop_set_object_data,
                                 ...
                                 target_object=
                                 friendly_shop_snapshot.current_state.friendly_relics[0].custom_data["rewards"][
                                     1].shop_id,
