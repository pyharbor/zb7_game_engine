...
def asdf():
    ...
    r = Relics.GraduationCap()
    r2 = Recruits.Arachnida.AsianForestScorpion(experience=GameConstants.Levels.level_5 + 2)
    r3 = Recruits.Arachnida.AsianForestScorpion()
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=r3, index=1)
    ...
    GameEngine.reconcile_shop_user_input(
        ...
        user_input=ShopUserInput(op=GameConstants.Opcodes.Shop.shop_set_object_data,
                                 ...
                                 target_object=friendly_shop_snapshot.current_state.friendly_recruits[0].shop_id,
    ...
    print(len(json.dumps(friendly_shop_snapshot.to_json()).encode("utf-8")))
    print(x.friendly_recruits[0].experience, GameConstants.Levels.level_7 + 2)
