...
def asdf():
    ...
    r1 = Relics.AmazonPrime(shop_id=20)
    friendly_shop_snapshot.current_state.shop[0] = r1
    ...
    print([x.sub_type_as_text for x in friendly_shop_snapshot.current_state.friendly_relics[0].custom_data["rewards"]])
    copy_ = ShopSnapshotSerializer.from_json(friendly_shop_snapshot.to_json())
    print([x.sub_type_as_text for x in copy_.current_state.friendly_relics[0].custom_data["rewards"]])
    ...
    GameEngine.reconcile_shop_user_input(
        ...
        user_input=ShopUserInput(op=GameConstants.Opcodes.Shop.shop_set_object_data,
                                 team_object=friendly_shop_snapshot.current_state.friendly_relics[0],
                                 target_object=friendly_shop_snapshot.current_state.friendly_relics[0].custom_data["rewards"][1].shop_id,
