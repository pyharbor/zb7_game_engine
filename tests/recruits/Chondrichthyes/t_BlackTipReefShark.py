...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.AsianForestScorpion(health=100), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Chondrichthyes.BlackTipReefShark(melee_attack=120, ranged_attack=120,
                                                                                                       health=200, max_health=200), index=1)
