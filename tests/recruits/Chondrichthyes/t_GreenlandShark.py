...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Chondrichthyes.BaskingShark(), index=0)
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Chondrichthyes.GreenlandShark(), index=3)

    enemy_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.AsianForestScorpion(), index=0)
    
    # Battle
    print(friendly_shop_snapshot.current_state.friendly_recruits[3])
