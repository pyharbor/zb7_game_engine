...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Chondrichthyes.GreatHammerheadShark(melee_attack=100), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Chondrichthyes.BaskingShark(), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Chondrichthyes.BaskingShark(), index=2)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Chondrichthyes.BaskingShark(), index=3)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Chondrichthyes.BaskingShark(), index=4)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Chondrichthyes.BaskingShark(), index=5)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Chondrichthyes.GreatWhiteShark(), index=6)
