...
def asdf():
    ...
    friendly_shop_snapshot = ShopSnapshotSerializer.start_new_run(deck=deck, username="a5", run_uuid=uuid1)
    enemy_shop_snapshot = ShopSnapshotSerializer.start_new_run(deck=deck, username="a2", run_uuid=uuid1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Chondrichthyes.ShortTailStingray(health=300, max_health=300), index=0)
