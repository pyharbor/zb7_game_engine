...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Chondrichthyes.GreatWhiteShark(melee_attack=10, health=100, max_health=100), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Chondrichthyes.NurseShark(), index=1)
