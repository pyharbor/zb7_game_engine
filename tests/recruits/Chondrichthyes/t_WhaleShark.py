...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Chondrichthyes.WhaleShark(), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Cetacea.Dolphin(), index=1)
