...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Chondrichthyes.GreatWhiteShark(), index=0)

    enemy_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.TarantulaHawk(), index=0)
    enemy_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.TarantulaHawk(), index=1)
    enemy_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.TarantulaHawk(), index=2)
