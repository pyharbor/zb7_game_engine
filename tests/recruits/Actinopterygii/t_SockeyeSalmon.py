...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Actinopterygii.AtlanticBluefinTuna(), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Actinopterygii.SockeyeSalmon(), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Ursidae.GrizzlyBear(), index=2)
