...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Actinopterygii.SunFish(health=80, max_health=80), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Actinopterygii.SunFish(), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Actinopterygii.SunFish(), index=2)

    enemy_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.AsianForestScorpion(), index=0)
    print(friendly_shop_snapshot.friendly_recruits[2])
