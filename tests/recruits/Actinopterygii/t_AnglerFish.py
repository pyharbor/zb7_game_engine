...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Mollusca.Cuttlefish(), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Mollusca.GiantSquid(ranged_attack=20), index=1)
