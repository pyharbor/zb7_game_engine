...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Pinnipedia.HarpSeal(), index=0)
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Ursidae.GrizzlyBear(), index=4)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Canidae.AfricanWildDog(), index=5)
