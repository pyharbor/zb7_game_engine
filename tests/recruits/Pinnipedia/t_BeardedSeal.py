...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Pinnipedia.BeardedSeal(experience=GameConstants.Levels.level_5, armor=7), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Pinnipedia.BeardedSeal(experience=GameConstants.Levels.level_5), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Pinnipedia.BeardedSeal(), index=2)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Pinnipedia.HarpSeal(), index=3)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Pinnipedia.HarpSeal(), index=4)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Pinnipedia.HarpSeal(), index=5)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Pinnipedia.HarpSeal(), index=6)

    enemy_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.AsianForestScorpion(melee_attack=200, initiative=100.0), index=0)
