...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Primates.EasternGorilla(), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Primates.HowlerMonkey(), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Primates.Bonobo(initiative=51.0), index=2)
