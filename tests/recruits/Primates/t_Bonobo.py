...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Primates.Bonobo(), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Primates.Bonobo(), index=1)
