...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Primates.ProboscisMonkey(experience=GameConstants.Levels.level_5), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Primates.EasternGorilla(experience=GameConstants.Levels.level_5), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Primates.Bonobo(), index=2)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Primates.Bonobo(), index=3)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Primates.Bonobo(), index=4)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Primates.Bonobo(), index=5)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Primates.Bonobo(), index=6)
