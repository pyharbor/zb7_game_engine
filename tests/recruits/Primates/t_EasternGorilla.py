...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Primates.EasternGorilla(experience=GameConstants.Levels.level_4), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Primates.LarGibon(), index=1)
