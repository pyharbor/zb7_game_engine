...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Aves.GriffonVulture(), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.SixEyedSandSpider(), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Aves.BurrowingOwl(), index=2)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Aves.BurrowingOwl(), index=3)

    enemy_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.AsianForestScorpion(), index=0)
    enemy_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.AsianForestScorpion(ranged_attack=27), index=1)
    enemy_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.AsianForestScorpion(ranged_attack=27), index=2)
    enemy_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.AsianForestScorpion(ranged_attack=27),
                                                  index=2)
