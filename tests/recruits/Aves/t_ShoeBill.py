...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Aves.ShoeBill(experience=GameConstants.Levels.level_4), index=0)
    friendly_shop_snapshot.current_state.add_recruit(
        recruit=Recruits.Aves.ShoeBill(experience=GameConstants.Levels.level_4), index=1)
    friendly_shop_snapshot.current_state.add_recruit(
        recruit=Recruits.Aves.ShoeBill(experience=GameConstants.Levels.level_4), index=2)
    friendly_shop_snapshot.current_state.add_recruit(
        recruit=Recruits.Aves.ShoeBill(experience=GameConstants.Levels.level_4), index=3)
    friendly_shop_snapshot.current_state.add_recruit(
        recruit=Recruits.Aves.ShoeBill(experience=GameConstants.Levels.level_4), index=4)
    friendly_shop_snapshot.current_state.add_recruit(
        recruit=Recruits.Aves.ShoeBill(experience=GameConstants.Levels.level_4), index=5)
    friendly_shop_snapshot.current_state.add_recruit(
        recruit=Recruits.Aves.ShoeBill(experience=GameConstants.Levels.level_4), index=6)
