...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Aves.GoldenEagle(), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Aves.Chickadee(), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Aves.Chickadee(), index=2)
