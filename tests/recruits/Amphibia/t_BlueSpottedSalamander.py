...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Amphibia.AfricanBullFrog(), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Amphibia.AfricanBullFrog(), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Amphibia.AfricanBullFrog(), index=2)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Amphibia.BlueSpottedSalamander(max_health=100),
                                                     index=3)
