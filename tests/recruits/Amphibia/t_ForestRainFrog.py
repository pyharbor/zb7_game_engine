...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Amphibia.ForestRainFrog(), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Amphibia.JapaneseGiantSalamander(experience=1), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Amphibia.JapaneseGiantSalamander(), index=2)
