...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Amphibia.TreeFrog(health=100, max_health=100), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Amphibia.TreeFrog(), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Amphibia.TreeFrog(), index=2)
