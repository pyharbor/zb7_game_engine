...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.DivingBellSpider(), index=0)
    r = Recruits.Arachnida.BrownRecluseSpider(shop_id=friendly_shop_snapshot.current_state.get_next_shop_id())
