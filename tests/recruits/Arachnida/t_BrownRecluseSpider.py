...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.BrownRecluseSpider(health=100, max_health=100,
                                                                                                   experience=GameConstants.Levels.level_8), index=0)
