...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.AsianForestScorpion(), index=0)

    enemy_shop_snapshot.current_state.add_recruit(recruit=Recruits.Chondrichthyes.GreatWhiteShark(melee_attack=100), index=0)
