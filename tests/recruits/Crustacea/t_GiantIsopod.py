...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Crustacea.GiantIsopod(), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Crustacea.BlackClawedCrab(armor=50), index=1)
