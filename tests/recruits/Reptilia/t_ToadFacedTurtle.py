...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Reptilia.NileCrocodile(), index=0)
    friendly_shop_snapshot.current_state.shop[0] = Recruits.Reptilia.ToadFacedTurtle(shop_id=25)
