...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Reptilia.AldabraGiantTortoise(), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Reptilia.AldabraGiantTortoise(), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Reptilia.AldabraGiantTortoise(), index=2)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Reptilia.AldabraGiantTortoise(), index=3)
