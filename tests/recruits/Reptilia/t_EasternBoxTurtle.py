...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Reptilia.EasternBoxTurtle(experience=GameConstants.Levels.level_3, melee_attack=30), index=0)
