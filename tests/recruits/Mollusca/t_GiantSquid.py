...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Mollusca.GiantSquid(experience=GameConstants.Levels.level_5), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Mollusca.Nautilus(), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Mollusca.Nautilus(), index=2)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Mollusca.Nautilus(), index=3)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Mollusca.Nautilus(), index=4)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Mollusca.Nautilus(), index=5)
