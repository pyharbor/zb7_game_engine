...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Mollusca.GiantSquid(health=55, max_health=55), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Mollusca.VampireSquid(), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Actinopterygii.AnglerFish(), index=2)

    enemy_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.AsianForestScorpion(health=60), index=0)
