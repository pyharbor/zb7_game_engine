...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Mollusca.GiantPacificOctopus(), index=6)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Mollusca.Cuttlefish(), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Mollusca.Cuttlefish(), index=2)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Mollusca.Cuttlefish(), index=3)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Mollusca.Cuttlefish(), index=4)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Mollusca.Cuttlefish(), index=5)
