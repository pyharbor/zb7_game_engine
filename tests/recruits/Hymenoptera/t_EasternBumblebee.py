...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Hymenoptera.EasternBumblebee(experience=GameConstants.Levels.level_5 - 1), index=0)
    friendly_shop_snapshot.current_state.add_recruit(
        recruit=Recruits.Hymenoptera.BullAnt(), index=1)
