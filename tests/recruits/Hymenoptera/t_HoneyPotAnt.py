...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Hymenoptera.HoneyPotAnt(experience=GameConstants.Levels.level_8), index=0),
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Ursidae.GrizzlyBear(), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Hymenoptera.FireAnt(), index=2)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Hymenoptera.QueenAnt(), index=3)
    ...
    print(Debug.ShopSnapshotSerializer.print(friendly_shop_snapshot))
    print(friendly_shop_snapshot.friendly_recruits[0].custom_data)
    # Shop Start of turn
    ...
    print(friendly_shop_snapshot.to_json())
    print(len(json.dumps(friendly_shop_snapshot.to_json()).encode("utf-8")))
    print(friendly_shop_snapshot.current_state.friendly_recruits[0].custom_data)
