...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Hymenoptera.GhostAnt(), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Hymenoptera.GhostAnt(), index=1)
