...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Hymenoptera.FireAnt(melee_attack=10), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Hymenoptera.FireAnt(), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Hymenoptera.FireAnt(), index=2)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Hymenoptera.FireAnt(), index=3)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Hymenoptera.FireAnt(), index=4)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Hymenoptera.FireAnt(), index=5)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Coleoptera.Firefly(), index=6)
