...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Blattodea.HissingCockroach(), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Mantodea.ShieldMantis(), index=1)
