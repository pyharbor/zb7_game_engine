...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Mantodea.EuropeanMantis(experience=GameConstants.Levels.level_3), index=1)
    ...
    battle_snapshot = GameEngine.reconcile_shop_user_input(
        shop_snapshot=friendly_shop_snapshot, user_input=ShopUserInput(op=GameConstants.Opcodes.Stack.shop_end_of_turn),
    )
