...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Mantodea.OrchidMantis(armor=100), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Mantodea.OrchidMantis(), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Mantodea.OrchidMantis(), index=2)
