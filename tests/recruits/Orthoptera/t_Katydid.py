...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Orthoptera.MoleCricket(health=300, max_health=300), index=0)
    friendly_shop_snapshot.current_state.add_recruit(
        recruit=Recruits.Mantodea.OrchidMantis(health=300, max_health=300), index=2)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Orthoptera.Katydid(), index=1)
