...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Ursidae.BlackBear(ranged_attack=1), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Ursidae.BlackBear(ranged_attack=1), index=2)
