...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Canidae.AfricanWildDog(), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Canidae.AfricanWildDog(), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Canidae.AfricanWildDog(), index=2)
