...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Coleoptera.GiraffeBeetle(), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Coleoptera.GiraffeBeetle(), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Coleoptera.GiraffeBeetle(), index=2)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Coleoptera.BombardierBeetle(health=200, max_health=200), index=3)

    enemy_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.AsianForestScorpion(), index=0)
    enemy_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.AsianForestScorpion(), index=1)
    enemy_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.AsianForestScorpion(), index=2)
    enemy_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.AsianForestScorpion(), index=3)
    enemy_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.AsianForestScorpion(), index=4)
