...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Coleoptera.DungBeetle(), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Coleoptera.DungBeetle(), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Coleoptera.DungBeetle(), index=2)

    enemy_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.AsianForestScorpion(), index=0)
    enemy_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.AsianForestScorpion(melee_attack=41), index=1)
