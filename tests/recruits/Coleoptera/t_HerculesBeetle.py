...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Coleoptera.HerculesBeetle(melee_attack=100, experience=GameConstants.Levels.level_3), index=0)
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Coleoptera.GiraffeBeetle(), index=4)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Coleoptera.GiraffeBeetle(), index=5)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Coleoptera.GiraffeBeetle(), index=6)
