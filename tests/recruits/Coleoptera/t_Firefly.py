...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Coleoptera.Firefly(), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Coleoptera.Firefly(), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Coleoptera.GiraffeBeetle(), index=2)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Coleoptera.GiraffeBeetle(), index=3)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Coleoptera.BombardierBeetle(), index=4)

    enemy_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.AsianForestScorpion(health=200, max_health=200), index=0)
    enemy_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.AsianForestScorpion(melee_attack=1), index=1)
    enemy_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.AsianForestScorpion(melee_attack=1), index=2)
