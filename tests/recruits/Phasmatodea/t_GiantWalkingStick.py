...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Phasmatodea.GiantWalkingStick(health=200, max_health=200,
                                                                                                    experience=10), index=0)

    enemy_shop_snapshot.current_state.add_recruit(recruit=Recruits.Arachnida.AsianForestScorpion(melee_attack=20), index=0)
    print(friendly_shop_snapshot.friendly_recruits[0])
    # Battle
