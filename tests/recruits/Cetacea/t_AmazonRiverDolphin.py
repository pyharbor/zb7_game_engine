...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Cetacea.AmazonRiverDolphin(), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Hippopotamidae.Hippopotamus(), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Cetacea.BlueWhale(), index=2)
