...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Cetacea.PilotWhale(), index=0)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Cetacea.PilotWhale(), index=1)
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Cetacea.PilotWhale(), index=2)
