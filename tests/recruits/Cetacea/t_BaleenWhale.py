...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.Cetacea.BaleenWhale(), index=0)
    ...
    print([x.sub_type_as_text for x in friendly_shop_snapshot.current_state.friendly_recruits])
