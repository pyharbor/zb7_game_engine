...
def asdf():
    ...
    s = ShopUserInput(op=GameConstants.Opcodes.Shop.shop_move,
                      team_object_1=shop_snapshot.current_state.friendly_recruits[0],
                      team_object_2=shop_snapshot.current_state.friendly_recruits[1])
    Debug.ShopSnapshotSerializer.print(shop_snapshot)
