...
class ShopGainMoney(AnimationEventSerializer):
    def __init__(self, state_id: int):
        super().__init__(animation_type_as_text=GameConstants.Animations.ShopGainMoney,
                         state_id=state_id)
    ...
    @classmethod
    def from_bytes(cls, _bytes: bytes) -> "ShopGainMoney":
        return StateId.from_bytes(cls, _bytes)


if __name__ == "__main__":
    ShopGainMoney(state_id=0)