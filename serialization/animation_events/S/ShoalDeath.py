...
class ShoalDeath(AnimationEventSerializer):
    def __init__(self, state_id: int, battle_id: int, shop_id: int):
        super().__init__(animation_type_as_text=GameConstants.Animations.ShoalDeath,
                         state_id=state_id)
    ...
    @classmethod
    def from_bytes(cls, _bytes: bytes) -> "ShoalDeath":
        return BasicIds.from_bytes(cls, _bytes)


if __name__ == "__main__":
    ShoalDeath(state_id=0)