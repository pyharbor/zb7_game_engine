...
class BattleDraw(AnimationEventSerializer):
    def __init__(self, state_id: int):
        super().__init__(animation_type_as_text=GameConstants.Animations.BattleDraw,
                         state_id=state_id)
    ...
    @classmethod
    def from_bytes(cls, _bytes: bytes) -> "BattleDraw":
        return StateId.from_bytes(cls, _bytes)


if __name__ == "__main__":
    BattleDraw(state_id=0)