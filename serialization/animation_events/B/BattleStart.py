...
class BattleStart(AnimationEventSerializer):
    def __init__(self, state_id: int):
        super().__init__(animation_type_as_text=GameConstants.Animations.BattleStart,
                         state_id=state_id)
    ...
    @classmethod
    def from_bytes(cls, _bytes: bytes) -> "BattleStart":
        return StateId.from_bytes(cls, _bytes)


if __name__ == "__main__":
    BattleStart(state_id=0)