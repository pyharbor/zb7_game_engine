...
class UpgradeRelic(AnimationEventSerializer):
    def __init__(self, state_id: int):
        super().__init__(animation_type_as_text=GameConstants.Animations.UpgradeRelic,
                         state_id=state_id)
    ...
    @classmethod
    def from_bytes(cls, _bytes: bytes) -> "UpgradeRelic":
        return BasicIds.from_bytes(cls, _bytes)


if __name__ == "__main__":
    UpgradeRelic(state_id=0)