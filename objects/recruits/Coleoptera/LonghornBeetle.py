...
class LonghornBeetle(RecruitSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=122,
                         sub_type_as_text="LonghornBeetle", 
                         **kwargs)
    ...
    def shop_end_of_turn(self, shop_state: "ShopStateSerializer", state_set: "StateSet", stack_item: "StackItem",
        ...
        for x in shop_state.friendly_recruits:
            if GameConstants.ScientificNames.Insecta in x.binomial_nomenclature:
                x.shop_buff_stats(
        ...
        g1.set_state_id(state_id=state_set.add_state(state=shop_state))
