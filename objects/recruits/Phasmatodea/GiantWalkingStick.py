...
class GiantWalkingStick(RecruitSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=116,
                         sub_type_as_text="GiantWalkingStick", 
                         **kwargs)
    ...
    def passive_battle_ability(self,
        ...
        if original_shop_state is not None:
            ...
            obj.experience += 1
        self.experience += 1
        e = Animations.BattleGainExperience(
    ...
    def start_of_battle(self,
        ...
        self.generic_ability_notification(
            ...
            animation_event_sequence=animation_event_sequence)
        s = Statuses.Camouflage(counter=1)
        self.add_status(status=s, state_set=state_set, animation_event_sequence=animation_event_sequence,
                        battle_state=battle_state, original_shop_state=original_shop_state,
                        enemy=None)
        info = battle_state.get_battle_info(self.battle_id)
        g = Group()
        for x in info.friendly_recruits:
            s = x.get_status(sub_type_as_text="Camouflage")
            if s is not None:
                x.battle_buff_stats(
                    battle_state=battle_state,
                    state_set=state_set,
