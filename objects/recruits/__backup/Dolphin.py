...
class Dolphin(RecruitSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=6,
                         sub_type_as_text="Dolphin", 
                         **kwargs)
    ...
    def shop_end_of_turn(self, shop_state: "ShopStateSerializer", state_set: "StateSet", stack_item: "StackItem",
        ...
        for x in shop_state.friendly_recruits:
            ...
            if GameConstants.ScientificNames.Cetacea in x.binomial_nomenclature.order:
                health_buff += 2
            for h in GameConstants.Habitats.Oceanic:
                if h in x.habitats:
                    ...
                    ranged_buff += 1
                    break
            x.shop_buff_stats(shop_state=shop_state,
        ...
        e.set_state_id(state_set.add_state(shop_state))
