...
class JapaneseGiantSalamander(RecruitSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=38,
                         sub_type_as_text="JapaneseGiantSalamander", 
                         **kwargs)
        ...
        for x in info.friendly_recruits:
            ...
            if percentage > 0.0:
                x.battle_heal(
                    ...
                    animation_event_sequence=animation_event_sequence,
                    healer=self,
                    heal=int(x.max_health * percentage),
                    group=g
                )
