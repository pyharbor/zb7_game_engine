...
class Chickadee(RecruitSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=109,
                         sub_type_as_text="Chickadee", 
                         **kwargs)
        ...
        for x in shop_state.friendly_recruits:
            ...
            if GameConstants.ScientificNames.Aves in x.binomial_nomenclature:
                if self.experience < GameConstants.Levels.level_3:
                    ...
                    health_buff += 4
                    initiative_buff += 2
            for h in GameConstants.Habitats.TemperateForests:
