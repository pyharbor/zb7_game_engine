...
class EasternBoxTurtle(RecruitSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=75,
                         sub_type_as_text="EasternBoxTurtle", 
                         **kwargs)
    ...
    def battle_receive_damage(self, damage: int,
        ...
        if self.health < original_health:
            self.add_status(status=Statuses.Protected(counter=2),
