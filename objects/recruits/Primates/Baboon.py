...
class Baboon(RecruitSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=31,
                         sub_type_as_text="Baboon", 
                         **kwargs)
    ...
    def start_of_battle(self,
        ...
        e = Animations.Taunt(state_id=state_set.add_state(state=battle_state),
