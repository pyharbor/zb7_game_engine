...
class LarGibon(RecruitSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=89,
                         sub_type_as_text="LarGibon", 
                         **kwargs)
    ...
    def shop_start_of_turn(self, shop_state: "ShopStateSerializer", state_set: "StateSet", stack_item: "StackItem",
        ...
        for x in shop_state.friendly_recruits:
            ...
            if ranged_buff > 0 or health_buff > 0 or melee_buff > 0:
                x.shop_buff_stats(melee=melee_buff,
                                  ranged=ranged_buff,
                                  health=health_buff,
