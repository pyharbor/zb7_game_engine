...
class Lionfish(RecruitSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=227,
                         sub_type_as_text="Lionfish", 
                         **kwargs)
    ...
    def battle_receive_damage(self, damage: int,
        ...
        enemy.add_status(Statuses.NeuromuscularToxin(counter=self.experience), battle_state=battle_state,
                         state_set=state_set, animation_event_sequence=animation_event_sequence, origin=origin,
                         enemy=self,
