...
class PlasmaShield(RelicSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=205,
                         sub_type_as_text="PlasmaShield", 
                         **kwargs)
            ...
            if team_match is None:
                ...
                for x in shop_state.friendly_recruits:
                    ...
                    if x.shop_id == self.target:
                        x.shop_buff_stats(armor=single_buff,
                        ...
                        x.shop_debuff_stats(melee=single_debuff,
                                            ranged=single_debuff,
                                            shop_state=shop_state,
                                            state_set=state_set,
                                            stack_item=stack_item,
                                            buffer=self,
                        ...
                        x.shop_buff_stats(armor=group_buff,
                                          shop_state=shop_state,
                                          state_set=state_set,
                                          stack_item=stack_item,
                                          buffer=self,
                                          group=g,
                                          animation_event_sequence=animation_event_sequence)
                        x.shop_debuff_stats(melee=group_debuff,
                                            ranged=group_debuff,
                                            shop_state=shop_state,
                                            state_set=state_set,
                                            stack_item=stack_item,
