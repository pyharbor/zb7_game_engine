...
class EntangledWeb(StatusSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=150,
                         sub_type_as_text="EntangledWeb", 
                         **kwargs)
    ...
    def lt_battle_attack_with_range(self, battle_state: "BattleStateSerializer",
        ...
        should_return = True
        e = Animations.EntangledWebEffect(state_id=state_set.add_state(battle_state), battle_id=self.target.battle_id)
