...
class Protected(StatusSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=152,
                         sub_type_as_text="Protected", 
                         **kwargs)
    ...
    def lt_battle_receive_damage(self, damage: int,
            ...
            if damage_reduction_stack is not None:
                damage_reduction_stack.append(
                    dict(amount=damage, sub_type_as_int=GameConstants.DamageReductionStack.Protected))
            return [0, False]
