...
class RecruitTestTemplate:
    def __new__(cls, recruit: RecruitSerializer) -> str:
...
def asdf():
    ...
    friendly_shop_snapshot.current_state.add_recruit(recruit=Recruits.{recruit.main_species}.{recruit.sub_type_as_text}(), index=0)
