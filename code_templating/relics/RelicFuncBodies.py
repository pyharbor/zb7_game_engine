    ...
    def __init__(self, module_path: str, sub_type_as_text: str):
        ...
        try:
            ...
            for x in function_names:
                self.code_by_function_name[x] = RelicFuncBodies.get_function_body_from_module(
                    module_path=module_path,
                    klass_name=sub_type_as_text,
                    function_name=x,
                )
            for x in protected_function_names:
                self.code_by_function_name[x] = RelicFuncBodies.get_section_from_function_body_from_module(
                    module_path=module_path,
                    klass_name=sub_type_as_text,
                    function_name=x,
