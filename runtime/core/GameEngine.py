...
class GameEngine:
    ...
    @staticmethod
    def reconcile_shop_user_input(shop_snapshot: ShopSnapshotSerializer, user_input: ShopUserInput):
    ...
    @staticmethod
    def reconcile_battle(friendly_shop_snapshot: ShopSnapshotSerializer,
                         enemy_shop_snapshot: ShopSnapshotSerializer) -> BattleSnapshotSerializer:
