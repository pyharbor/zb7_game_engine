...
class RoughSkinnedNewt(RecruitSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=51,
                         sub_type_as_text="RoughSkinnedNewt", 
                         **kwargs)
    ...
    def start_of_battle(self,
        ...
        #     if GameConstants.ScientificNames.Amphibia in x.binomial_nomenclature and x.shop_id != self.shop_id:
        #         amount = 0
        ...
        #         else:
        #             amount = 3
        #         status = Statuses.AcridSlimeSkin(counter=amount)
        #         x.add_status(
        ...
        #             group=g
        #         )
        status = Statuses.AcridSlimeSkin(counter=self.experience)
        self.add_status(
            battle_state=battle_state,
            state_set=state_set,
            enemy=None,
