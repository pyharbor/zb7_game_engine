...
class PufferFish(RecruitSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=82,
                         sub_type_as_text="PufferFish", 
                         **kwargs)
    ...
    def battle_receive_damage(self, damage: int,
        ...
        enemy = self.get_random_enemy(battle_state=battle_state)
