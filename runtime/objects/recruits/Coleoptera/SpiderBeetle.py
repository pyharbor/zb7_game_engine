...
class SpiderBeetle(RecruitSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=127,
                         sub_type_as_text="SpiderBeetle", 
                         **kwargs)
    ...
    def start_of_battle(self,
        ...
        if self.experience < GameConstants.Levels.level_2:
            ...
            self.add_status(Statuses.Carapace(counter=2), battle_state=battle_state, state_set=state_set,
                            animation_event_sequence=animation_event_sequence,
                            enemy=None,
                            original_shop_state=original_shop_state)
    ...
    def shop_bought(self, shop_state: "ShopStateSerializer", state_set: "StateSet", stack_item: "StackItem",
        ...
        for x in shop_state.friendly_recruits:
            if GameConstants.ScientificNames.Coleoptera in x.binomial_nomenclature:
    ...
    def shop_sold(self, shop_state: "ShopStateSerializer", state_set: "StateSet", stack_item: "StackItem",
        ...
        g = Group()
        for x in shop_state.friendly_recruits:
            if GameConstants.ScientificNames.Coleoptera in x.binomial_nomenclature and GameConstants.ScientificNames.Arachnida in x.binomial_nomenclature:
    ...
    def battle_friendly_recruit_summoned(self, battle_state: "BattleStateSerializer",
        ...
        if GameConstants.ScientificNames.Coleoptera in recruit.binomial_nomenclature:
