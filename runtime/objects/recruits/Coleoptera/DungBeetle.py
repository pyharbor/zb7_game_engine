...
class DungBeetle(RecruitSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=126,
                         sub_type_as_text="DungBeetle", 
                         **kwargs)
    ...
    def passive_battle_ability(self,
        ...
        highest_attack_enemy = max(info.enemy_recruits,
                                   key=lambda recruit: recruit.melee_attack + recruit.ranged_attack)
        highest_attack_enemy.battle_debuff_stats(
            battle_state=battle_state,
            state_set=state_set,
            stack_item=stack_item,
            animation_event_sequence=animation_event_sequence,
