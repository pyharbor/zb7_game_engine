...
class TasmanianGiantCrab(RecruitSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=47,
                         sub_type_as_text="TasmanianGiantCrab", 
                         **kwargs)
    ...
    def shop_start_of_turn(self, shop_state: "ShopStateSerializer", state_set: "StateSet", stack_item: "StackItem",
        ...
        if logical_level == 1:
            ...
            armor_amount = 15
            multiplier = 3
        diff = int(max(0, self.armor - armor_amount) * multiplier)
        self.armor = armor_amount
