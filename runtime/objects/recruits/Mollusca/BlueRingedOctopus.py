...
class BlueRingedOctopus(RecruitSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=94,
                         sub_type_as_text="BlueRingedOctopus", 
                         **kwargs)
    ...
    def passive_battle_ability(self,
        ...
        for x in info.enemy_recruits:
            x.add_status(
                ...
                group=g,
                animation_event_sequence=animation_event_sequence,
                status=Statuses.Tetrodotoxin(counter=1),
            )
    ...
    def shop_end_of_turn(self, shop_state: "ShopStateSerializer", state_set: "StateSet", stack_item: "StackItem",
        ...
        for x in shop_snapshot.friendly_recruits:
            if GameConstants.Habitats.Coastline in x.binomial_nomenclature:
