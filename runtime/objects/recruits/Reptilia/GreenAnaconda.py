...
class GreenAnaconda(RecruitSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=70,
                         sub_type_as_text="GreenAnaconda", 
                         **kwargs)
    ...
    def battle_attack_with_melee(self, battle_state: "BattleStateSerializer",
        ...
        if self.team_index == 0 and self.melee_attack > 0:
            ...
            if front_enemy.health <= 0:
                ...
                health_buff = int(front_enemy.max_health / 3)
                melee_buff = int(front_enemy.melee_attack / 3)
                ranged_buff = int(front_enemy.ranged_attack / 3)
