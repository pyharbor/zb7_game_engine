...
class JUUL(RelicSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=207,
                         sub_type_as_text="JUUL", 
                         **kwargs)
    ...
    def shop_set_object_data(self, shop_state: "ShopStateSerializer", state_set: "StateSet", stack_item: "StackItem",
        ...
        if user_input.set_shop_object_data_opcode == GameConstants.Opcodes.ObjectData.shop_set_custom:
            ...
            if team_match is None:
                ...
                single_initiative_buff = 30
                group_initiative_buff = 10
                g = Group()
                g2 = Group()
                for x in shop_state.friendly_recruits:
                    ...
                    if x.shop_id == self.target:
                        x.shop_buff_stats(shop_state=shop_state,
                                          ...
                                          buffer=self,
                                          group=g,
                                          initiative=single_initiative_buff,
                        ...
                        x.shop_buff_stats(shop_state=shop_state,
                                          ...
                                          stack_item=stack_item,
                                          buffer=self,
                                          initiative=group_initiative_buff,
                                          group=g,
                                          animation_event_sequence=animation_event_sequence)
