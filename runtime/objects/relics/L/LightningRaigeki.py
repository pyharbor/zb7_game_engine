...
class LightningRaigeki(RelicSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=194,
                         sub_type_as_text="LightningRaigeki", 
                         **kwargs)
    ...
    def passive_battle_ability(self,
        ...
        damage = 45
        try:
            info.enemy_recruits[0].battle_receive_unblockable_damage(damage=damage,
                                                                     enemy=self,
                                                                     state_set=state_set,
            ...
            print(f"{self.__class__.__name__} has no enemy recruits to damage")
            pass
