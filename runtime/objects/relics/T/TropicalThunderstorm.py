...
class TropicalThunderstorm(RelicSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=216,
                         sub_type_as_text="TropicalThunderstorm", 
                         **kwargs)
    ...
    def passive_battle_ability(self,
        ...
        damage = int(battle_state.random.randint(5, 15))
        target = battle_state.random.choice(info.enemy_recruits)
        target.battle_receive_unblockable_damage(damage=damage,
                                                 enemy=self,
                                                 state_set=state_set,
