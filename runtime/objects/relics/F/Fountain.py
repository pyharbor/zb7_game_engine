...
class Fountain(RelicSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=206,
                         sub_type_as_text="Fountain", 
                         **kwargs)
    ...
    def shop_set_object_data(self, shop_state: "ShopStateSerializer", state_set: "StateSet", stack_item: "StackItem",
        ...
        if user_input.set_shop_object_data_opcode == GameConstants.Opcodes.ObjectData.shop_set_custom:
            ...
            if team_match is None:
                ...
                single_attack_buff = 30
                group_health_debuff = 2
                group_attack_buff = 10
                g = Group()
                g2 = Group()
                for x in shop_state.friendly_recruits:
                    ...
                    if x.shop_id == self.target:
                        x.shop_buff_stats(health=single_attack_buff,
                                          max_health=single_attack_buff,
                        ...
                        x.shop_debuff_stats(melee=single_health_debuff,
                                            ranged=single_health_debuff,
                                            shop_state=shop_state,
                                            state_set=state_set,
                                            stack_item=stack_item,
                                            buffer=self,
                        ...
                        x.shop_buff_stats(health=group_attack_buff,
                                          max_health=group_attack_buff,
                                          shop_state=shop_state,
                                          state_set=state_set,
                                          stack_item=stack_item,
                                          buffer=self,
                                          group=g,
                                          animation_event_sequence=animation_event_sequence)
                        x.shop_debuff_stats(melee=group_health_debuff,
                                            ranged=group_health_debuff,
                                            shop_state=shop_state,
                                            state_set=state_set,
                                            stack_item=stack_item,
                                            buffer=self,
