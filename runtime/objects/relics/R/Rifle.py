...
class Rifle(RelicSerializer):
    def __init__(self, **kwargs):
        kwargs.pop("sub_type_as_int", None)
        kwargs.pop("sub_type_as_text", None)
        super().__init__(sub_type_as_int=204,
                         sub_type_as_text="Rifle", 
                         **kwargs)
            ...
            if team_match is None:
                ...
                for x in shop_state.friendly_recruits:
                    ...
                    if x.shop_id == self.target:
                        x.shop_buff_stats(ranged=single_attack_buff,
                        ...
                        x.shop_buff_stats(ranged=group_attack_buff,
                                          shop_state=shop_state,
                                          state_set=state_set,
                                          stack_item=stack_item,
                                          buffer=self,
